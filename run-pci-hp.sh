...
RP1="-device pcie-root-port,id=p1,slot=0 \
	-drive file=nvm.img,if=none,id=nvm0 \
	-device nvme,bus=p1,serial=deadbeef,drive=nvm0,id=n1 \
	-drive file=nvm2.img,if=none,id=nvm1 \
	-device nvme,bus=p1,serial=deadbeee,drive=nvm1,id=n2"
RP1="-device pcie-root-port,id=p1,slot=0 \
	-device pcie-root-port,id=p2,slot=1 "
RP1="\
-device pxb-pcie,id=pcie.1,bus_nr=15 \
