...
parser.add_argument('-b','--base', help='code base type: kernel/qemu', required=False, default='k')
...
parser.add_argument('--cs', dest='ignore_case', action='store_false')
parser.add_argument('--git', dest='git', action='store_true')
parser.add_argument('--no-git', dest='git', action='store_false')
parser.add_argument('--save-path', dest='save_path', action='store_true')
