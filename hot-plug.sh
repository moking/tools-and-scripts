...
NVME_CONFIG="-device pxb-pcie,id=pcie.1,bus_nr=15 \
...
RP1="-object memory-backend-file,id=cxl-mem1,share=on,mem-path=/tmp/cxltest.raw,size=512M \
    ...
    #device_add cxl-type3,bus=root_port13,memdev=cxl-mem1,lsa=cxl-lsa1,id=cxl-pmem0
    #device_add cxl-upstream,bus=root_port14,id=us0
    #device_add cxl-downstream,port=0,bus=us0,id=swport0,chassis=0,slot=4
    #device_add cxl-type3,bus=root_port14,memdev=cxl-mem2,lsa=cxl-lsa2,id=cxl-pmem1
    #device_add cxl-type3,bus=swport0,memdev=cxl-mem2,lsa=cxl-lsa2,id=cxl-pmem1 \
...
HB3="-object memory-backend-file,id=cxl-mem1,share=on,mem-path=/tmp/cxltest.raw,size=256M \
    ...
    # device_add cxl-type3,bus=swport0,memdev=cxl-mem0,lsa=cxl-lsa0,id=cxl-pmem0 \
